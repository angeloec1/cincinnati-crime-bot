# -*- coding: utf-8 -*-
"""crime_chatbot_streamlit

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1KJS73Q2smk1y5e2kmVdv_Ra9cCPFAH4m
"""

# crime_chatbot_streamlit.py
import os
...
# MLflow Setup
mlflow.set_tracking_uri("file:///Users/adamadembele/Desktop/BANA 7075 ML Systems Design/MLflowLogs")
...
# Call the LLM and log with MLflow
...
if __name__ == "__main__":
    ...
    **To open this app in your browser**, make sure you run this script using the command:
    ```bash
    streamlit run crime_chatbot_streamlit.py
    ```
    """)
